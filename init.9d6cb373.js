...
exports.getNextPoopTime = exports.getNextDieTime = exports.getNextHungerTime = exports.NIGHT_LENGTH = exports.DAY_LENGTH = exports.SCENE = exports.RAIN_CHANCE = exports.ICONS = exports.TICK_RATE = void 0;
...
const gameState = {
  ...
  wake() {
    ...
    (0, _ui.modScene)(_constants.SCENE[this.scene]);
  ...
  determineFoxState() {
    if (this.current === "IDLING") {
      if (_constants.SCENE[this.scene] === "rain") {
        (0, _ui.modFox)("rain");
      } else {
        (0, _ui.modFox)("idling");
      }
  ...
  changeWeather() {
    this.scene = (this.scene + 1) % _constants.SCENE.length;
    (0, _ui.modScene)(_constants.SCENE[this.scene]);
    this.determineFoxState();
  },
